...
export default async function Invite(props: InvitePageProps) {
  ...
  const inviteLink = `https://nlw19-nodejs.onrender.com/api-docs/json/invites/${subscriberId}`
    ...
    <div className="min-h-dvh flex items-center justify-between gap-16 flex-col md:flex-row">
      <div className="flex flex-col gap-10 w-full max-w-[550px]">
        ...
        <div className="space-y-2">
          <h1 className="text-4xl font-semibold font-heading text-grey-100 leading-none">
